    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <a href="{{ URL::to('/products') }}" class="btn mt-2" style="background-color: #ff0080; color: white;"><i class="bi bi-arrow-left"></i> Lanjut Belanja</a>
            </div>
            <!-- Order Summary -->
            <div class="col-lg-4">
                <div class="card p-3">
...
number_format($cart->calculatedPriceByQuantity(), 0, ',', '.') }}</span>
                        ...
                        <a href="{{ route('checkout.index') }}" class="btn" style="background-color: #ff0080; color: white;" w-100 mt-3">Lanjut ke Pembayaran</a>
                    </div>
                </div>
            </div>
        </div>
